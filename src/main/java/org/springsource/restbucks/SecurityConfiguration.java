 ...
 * <li>Configuring Spring Session to store sessions in a {@link Map} and expose the session using an HTTP header.</li>
 * </ol>
 *
...
class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	/**
	 * Configures a {@link SessionRepositoryFilter} to main an authentication session in a plain {@link Map} and exposing
	 * a reference to the authentication session in an HTTP header.
	 * 
	 * @return
	 */
	@Bean
